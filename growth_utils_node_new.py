...
def find_split_layers_param_quota(model, epoch, param_budget, percent, eigs):
    ...
    for i in range(int(limit)):
        ...
        if v >= 60:
            ...
            elif l_attribute[1] in [0, 1] and str(l_attribute[0]) in sel_block_attn_nums and param_budget_left_attn > 0:
                param_budget_left_attn -= (l[int(layer_num)].in_features + 1) * 2
...
def create_width_growth(
    ...
    growth_block -> current growthblock wrapped layer module (Eg. GrowthModel(fc1))
