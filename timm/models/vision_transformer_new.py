...
class Mlp(nn.Module):
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, drop=0.):
        ...
        self.fc1 = GrowthBlock(nn.Linear(in_features, hidden_features))
        self.act = act_layer()
        self.fc2 = GrowthBlock(nn.Linear(hidden_features, out_features))
...
class Attention(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        self.qkv = GrowthBlock(nn.Linear(dim, dim * 3, bias=qkv_bias))
        self.attn_drop = nn.Dropout(attn_drop)
        self.proj = GrowthBlock(nn.Linear(dim, dim))
...
class HybridEmbed(nn.Module):
    ...
    def __init__(self, backbone, img_size=224, feature_size=None, in_chans=3, embed_dim=768):
        ...
        self.proj = GrowthBlock(nn.Linear(feature_dim, embed_dim))
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        # Classifier head
        self.head = GrowthBlock(nn.Linear(embed_dim, num_classes)) if num_classes > 0 else nn.Identity()
    ...
    def reset_classifier(self, num_classes, global_pool=''):
        self.num_classes = num_classes
        self.head = GrowthBlock(nn.Linear(self.embed_dim, num_classes)) if num_classes > 0 else nn.Identity()
