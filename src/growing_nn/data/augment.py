...
Data-augmentation (DA) based on DINO's DA (https://github.com/facebookresearch/dino)
and timm's DA (https://github.com/rwightman/pytorch-image-models).
"""
import random
...
class GrayScale:
    """Randomly convert the PIL image to grayscale."""
...
class HorizontalFlip:
    """Randomly horizontally-flip the PIL image."""
...
# Backwards-compatible aliases matching the original (non-PEP8) names used
# by the upstream codebase.
